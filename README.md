...
```bash
# Поиск (основнаякоманда)
python3 scripts/search_engine.py "клеммник настройка" --top 10 --json 

# Переиндексация после обновления доков
python3 scripts/search_engine.py index

# Статистика
python3 scripts/search_engine.py --stats
 ```
